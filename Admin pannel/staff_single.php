...
<div class="navbar-custom">
    ...
    <ul class="list-unstyled topnav-menu topnav-menu-left mb-0">
        ...
        <li>
            <h4 class="page-title-main"> Staff single information </h4>
        </li>
    </ul>
                    ...
                    <div class="text-center card-body">
                        <div>
                            ...
                            <div class="text-start">
                                ...
                                <p class="text-muted font-13"><strong>Salary :</strong> <?php echo $message['salary'] ?></p>
                            </div>
                            ...
                            <div class=" card-body">
                                ...
                                <div class="tab-content">
                                    ...
                                    <div class="tab-pane" id="messages-b1">
                                        <p class="text-muted font-13"><strong> Staff type id :</strong><?php echo $message['staff_type_id'] ?></p>
