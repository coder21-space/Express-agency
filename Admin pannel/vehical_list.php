        ...
        <div class="modal-content">
            ...
            <div class="modal-body">
                <form id="insert-form">
                    ...
                    <div class="mb-3">
                        <input type="hidden" id="id">
                        <label for="vehical_no" class="form-label">vehical number</label>
                        <input type="number" class="form-control" id="vehical_no" placeholder="Enter vehical no" name="vehical_no">
                        <span class="text-danger" id="vehical_no_error"></span>
                    </div>
