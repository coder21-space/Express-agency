                                    ...
                                    <div class="card-body">
                                        ...
                                        <table id="datatable-buttons" class="table table-striped table-bordered dt-responsive nowrap">
                                            ...
                                            <tr>
                                                ...
                                                <th>Age</th>
                                                <th>Start date</th>
                                                <th><button type="button" class="btn btn-danger"><i class="fa-light fa-eye-slash">View</i></button><button type="button" class="btn btn-primary"><i class="fa-light fa-eye-slash">Edit</i></button><button type="button" class="btn btn-success"><i class="fa-light fa-eye-slash">Delete</i></button></th>
