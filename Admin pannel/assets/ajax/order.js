...
$(document).ready(function () {
  ...
  function getdata() {
    $.ajax({
      ...
      type: "POST",
      dataType: "json",
      data: { submit: "customer order list" },
    ...
    contacts.forEach((contact, index) => {
      previous += `
        <tr>
            ...
            <td>
                <div class="d-flex">
                <a href="customer_single.php"><button type="button"class="btn btn-outline-primary  mx-2 "><i class="fa-solid fa-location-crosshairs"></i></button></a>  
  ...
  $("#previous-data").on("click", function () {
    ...
    $.ajax({
      url: "add_customer_order_data.php",
      type: "POST",
      dataType: "json",
