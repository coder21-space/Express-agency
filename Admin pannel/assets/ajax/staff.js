      ...
      previous += `
        <tr>
            ...
            <td>
                ...
                <button type="button" class=" update mx-2 btn btn-primary waves-effect waves-light" data-bs-toggle="modal" data-id=${
                  contact.id
                } data-name=${
        contact.name
      } data-bs-target="#updateModal"><i class="mdi mdi-plus-circle me-1" 
                ></i></button>
