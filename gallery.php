            ...
            <div class="overlay" id="video_overlay">
                <div class="overlay_bg"></div>
                  <div class="play_pause row m0">          
                     ...
                     <button class="video-play" data-video-id="RJ7r6Iws7Nk" style="border: none;"><i class="fa-solid fa-play"  ></i></button> <P><h2>video</h2></P>                
              </div>
          </div>
      </div>
  </div>
...
<script>$(".video-play").modalVideo();</script>
