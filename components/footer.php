  <!-- START FOOTER  AREA -->
  <footer class="bg-black text-white pt-5 pb-4 footer" >
  ...
  <div class="container text-center text-md-left">
    ...
    <div class="row text-center text-md-left">
      ...
      <div class="col-md-3 col-lg-3 col-xl-2 mx-auto mt-3">
        ...
        <p>
          <a href="contactus.php" class="text-white" style="text-decoration: none;">book now</a>
        </p>
        <p>
          <a href="index.php" class="text-white" style="text-decoration: none;">deshboard</a>
        </p>
        <p>
          <a href="service.php" class="text-white" style="text-decoration: none;">services</a>
        </p>
        <p>
          <a href="contactus.php" class="text-white" style="text-decoration: none;">Checkout</a>
        </p>
      </div>
      ...
      <div class=" col-lg-3 mx-auto mt-3">
        ...
        <p>
          <a href="contactus.php" class="text-white" style="text-decoration: none;">Contact Us</a>
        </p>
      </div>
